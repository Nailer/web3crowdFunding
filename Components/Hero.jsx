          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                A decentralized, transparent crowdfunding platform on Hedera that empowers African founders and changemakers to launch campaigns and gain trust through on-chain accountability.
              </p>
              <a
                href="/"
                aria-label=""
            ...
            <div className="mt-15 w-full max-w-xl xl:px-8 xl:w-5/12">
